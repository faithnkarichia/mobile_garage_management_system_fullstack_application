                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">SKU: {item.id.toString().padStart(4, '0')}</div>
                        </div>
                      </div>
                    </td>
                    {/* <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-bold text-gray-900">Use Inventory Item</h2>
                  <button 
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-700 mb-2">Available: <span className="font-medium">{currentItem.quantity}</span></p>
                  </div>
                  <div>
                    <label htmlFor="useQuantity" className="block text-sm font-medium text-gray-700 mb-1">
                      Quantity to Use *
                    </label>
                    <input
                      type="number"
                      ...
                      name="useQuantity"
                      value={useQuantity}
                      onChange={(e) => setUseQuantity(Math.max(1, parseInt(e.target.value) || 1))}
