...
with app.app_context():
    ...
    # Seed customers
    cust1 = Customer(name="John Doe", phone_number="0712345678", location="Nairobi")
    cust2 = Customer(name="Jane Smith", phone_number="0798765432", location="Mombasa")
    ...
    # Seed users
    user1 = User(email="john@example.com", password="password123", role="customer", customer_id=cust1.id)
    user2 = User(email="jane@example.com", password="password123", role="customer", customer_id=cust2.id)
    user3 = User(email="alice@example.com", password="adminpass", role="admin", admin_id=admin1.id)
    user4 = User(email="bob@example.com", password="mechpass", role="mechanic", mechanic_id=mech1.id)
    user5 = User(email="charlie@example.com", password="mechpass", role="mechanic", mechanic_id=mech2.id)
    ...
    link1 = ServiceRequestInventory(service_request_id=req1.id, inventory_id=inv2.id)
    link2 = ServiceRequestInventory(service_request_id=req2.id, inventory_id=inv1.id)
